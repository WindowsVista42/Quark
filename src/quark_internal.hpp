...
// inline u32 transfer_queue_family; // Transfer queue family index, gets set as the graphics queue family if we dont
// have
//                                   // a transfer queue
...
//
// inline constexpr usize RENDER_DATA_MAX_COUNT = 1024 * 512; // Maximum number of items that can be stored in render
// data inline usize render_data_count;                            // Current render data size; inline RenderData*
// render_data;                            // Buffer for storing things that need to be rendered.
//
